...
/*;ÓÃ·¨£º
;${NSW_SetCtlText} ¿Ø¼þ¾ä±ú ÎÄ±¾ÎÄ¼þÃû³Æ
;´Ëºê¸Ä×ÔRestoolsµÄSetTextº¯Êý
;Á´½Ó£ºhttp://restools.hanzify.org/article.asp?id=29*/
# Èç¹ûÄã¶Ô³ÌÐòÉè¼Æ²»ÊìÏ¤£¬ÄÇÃ´Äã¿ÉÒÔ²»ÓÃÀí½âÕâ¸ö¹ý³Ì£¬°ÑËü¸´ÖÆµ½ÄãµÄ½Å±¾ÖÐ¾Í¿ÉÒÔÁË¡£
;  Exch $R0 ;${HWND}¿Ø¼þ¾ä±ú
;  Exch
;  Exch $R1 ;${FileName}ÎÄ¼þ
  StrCpy $R0 ${HWND}
  StrCpy $R1 "${FileName}"
  ...
  ClearErrors
  FileOpen $R2 $R1 r ;$R2 = ÎÄ¼þ¾ä±ú
  ${Unless} ${Errors} ;È·±£´ò¿ªÎÄ¼þÃ»ÓÐ·¢Éú´íÎó
    System::Call /NOUNLOAD "Kernel32::GetFileSize(i, i) i (R2, 0) .R3" ;$R3 = ÎÄ¼þ´óÐ¡
    IntOp $R3 $R3 + 1
